            ...
            core.invoke('plugin:webview|create_webview_window', {
                options: {
                    ...
                    parent: typeof options.parent === 'string'
                        ? options.parent
                        : (_a = options.parent) === null || _a === undefined ? undefined : _a.label,
                    label
                }
            })
...
function applyMixins(baseClass, extendedClasses) {
    (Array.isArray(extendedClasses)
        ...
        Object.getOwnPropertyNames(extendedClass.prototype).forEach((name) => {
            ...
            (_a = Object.getOwnPropertyDescriptor(extendedClass.prototype, name)) !== null && _a !== undefined ? _a : Object.create(null));
        });
    });
}
