...
function injectChannel(i) {
    var _a;
    if ('items' in i) {
        i.items = (_a = i.items) === null || _a === undefined ? undefined : _a.map((item) => 'rid' in item ? item : injectChannel(item));
    }
    ...
    if (opts && typeof opts === 'object') {
        ...
        if ('items' in opts && opts.items) {
            function prepareItem(i) {
                ...
                if ('item' in i && typeof i.item === 'object' && ((_a = i.item.About) === null || _a === undefined ? undefined : _a.icon)) {
...
class MenuItemBase extends core.Resource {
    ...
    constructor(rid, id, kind) {
        super(rid);
        /** @ignore */
        _MenuItemBase_id.set(this, undefined);
        /** @ignore */
        _MenuItemBase_kind.set(this, undefined);
