...
function mockInternals() {
    var _a;
    window.__TAURI_INTERNALS__ = (_a = window.__TAURI_INTERNALS__) !== null && _a !== undefined ? _a : {};
}
/**
...
function clearMocks() {
    ...
    if ((_a = window.__TAURI_INTERNALS__) === null || _a === undefined ? undefined : _a.convertFileSrc)
        // @ts-expect-error "The operand of a 'delete' operator must be optional' does not matter in this case
        delete window.__TAURI_INTERNALS__.convertFileSrc;
    if ((_b = window.__TAURI_INTERNALS__) === null || _b === undefined ? undefined : _b.invoke)
        // @ts-expect-error "The operand of a 'delete' operator must be optional' does not matter in this case
        delete window.__TAURI_INTERNALS__.invoke;
    if ((_c = window.__TAURI_INTERNALS__) === null || _c === undefined ? undefined : _c.metadata)
        // @ts-expect-error "The operand of a 'delete' operator must be optional' does not matter in this case
